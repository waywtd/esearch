package com.globalegrow.esearch.stat.event.mapred.stmtr.ods.searchbox.mapper;
 ...
 * </pre>
 */
public class SearchBoxEventMapper extends Mapper<LongWritable,Text, Text, NullWritable>
{
            ...
            throws IOException, InterruptedException
    {
        ...
        Map<String,String> resultMap=ServiceParser.mapperEmit(eventMap,MethodConstant.SEARCH_BOX_EVENT);
        if(StringUtils.isNotEmpty(resultMap) && resultMap.size()>0){
            key=new Text(resultMap.get(Constant.KEY));
            /*String path=CommonUtil.outputPath(MessageFormat.format(PathConstant.PATH_SEARCH_BOX_EVENT,alias),siteCode,CommonUtil.getPartitionDate(buffer.toString()));
