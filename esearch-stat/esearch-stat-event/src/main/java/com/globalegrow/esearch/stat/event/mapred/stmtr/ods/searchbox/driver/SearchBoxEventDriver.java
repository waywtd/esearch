package com.globalegrow.esearch.stat.event.mapred.stmtr.ods.searchbox.driver;
...
import com.globalegrow.esearch.stat.event.mapred.stmtr.ods.searchbox.mapper.SearchBoxEventMapper;
import com.globalegrow.esearch.util.CommonUtil;

/**
 * <pre>
 * 
 *  File: ListPageETLDriver.java
 * 
 ...
 * </pre>
 */
public class SearchBoxEventDriver extends Configured implements Tool
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ToolRunner.run(new SearchBoxEventDriver(), args);
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public int run(String[] args) throws Exception
    {
        ...
        Job job = Job.getInstance(conf, "SearchBoxEventDriver-"+args[1]);
        ...
        job.setJarByClass(SearchBoxEventDriver.class);
        job.setMapperClass(SearchBoxEventMapper.class);
    ...
    private String getOutPath(String[] args){
        ...
        String path=CommonUtil.outputPath(MessageFormat.format(PathConstant.PATH_SEARCH_BOX_EVENT,args[2]),args[1],CommonUtil.getPartitionDate(buffer.toString()));
