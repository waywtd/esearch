package com.globalegrow.esearch.stat.event.mapred.stmtr.website.searchWord.bpoint.mapper;
...
public class SearchWordMapper extends Mapper<LongWritable, Text, Text, Text>
{
            ...
            throws IOException, InterruptedException
    {
        ...
        Map<String,String> resultMap=ServiceParser.mapperEmit(eventMap,MethodConstant.SEARCH_WORD_B_POINT);
