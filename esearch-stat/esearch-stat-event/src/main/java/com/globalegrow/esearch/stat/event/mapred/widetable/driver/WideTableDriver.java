...
import com.globalegrow.esearch.stat.event.mapred.widetable.mapper.WideTableMapper;
 ...
 * </pre>
 */
public class WideTableDriver extends Configured implements Tool {

    final Long MAP_SPLIT_SIZE = 256 * 1024 * 1024L*2;
    private static Logger log = LogManager.getLogger(WideTableMapper.class);

    /**
     * @param args domain,inputPath,outputPath,queue
     */
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new WideTableDriver(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        conf.set(Constant.PATH, outputPath);
        Job job = Job.getInstance(conf,"wide-table-" + args[0] + "-job");
        ...
        job.setJarByClass(WideTableDriver.class);
