...
#debug Options
#JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8061,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.globalegrow.esearch.realtime.streaming.RealTimeStart 1>>/dev/null 2>&1 &"

echo $RUN_CMD
eval $RUN_CMD
echo "esearch-hadoop server start!"
